...
public:
	...
	// BIP16 is P2SH
        consensus.BIP16Height = 0; // P2SH from start
	// BIP34 is block v2
	...
	// BIP66 is Strict DER signatures
        ...
        // Deployment of BIP68, BIP112, and BIP113, sequence locks, always active in Bitcoin Edu
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = Consensus::BIP9Deployment::ALWAYS_ACTIVE;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;

        // Deployment of SegWit (BIP141, BIP143, and BIP147), always active in Bitcoin Edu
        ...
        pchMessageStart[2] = 0xc4; // was b4 for original btc, changed for Edu
